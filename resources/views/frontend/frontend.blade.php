                    ...
                    <div class="col-lg-6 m-auto">
                        <div class="card mt-4">
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    <form action="{{route('compare.products')}}" method="post">
                                        @csrf
                                        <div class="mt-4">
                                        ...
                                        <div class="mt-4">
                                            <select name="product_2" id="" class="form-control">
                                                <option value="">Select Product</option>
                                                @foreach ($product as $prod)
                            ...
                            <div class="product-area clearfix row">
                                ...
                                <div class="grid col-lg-4">
                                    <div class="product-pic">
                                        <img src="{{ asset('uploads/product/product_preview/')}}/{{ $prod->product_image }}" alt>
                                        @if ($prod->discount == '0')

                                        @else

                                        <span class="theme-badge-2">{{ $prod->discount }}% Off!</span>
                                        ...
                                        <div class="actions">
                                            <ul>
                                                ...
                                                <li>
                                                    <a class="quickview_btn" data-bs-toggle="modal" href="#product_id{{ $prod->id }}" role="button" tabindex="0"><svg width="48px" height="48px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Visible (eye)</title> <path d="M22 12C22 12 19 18 12 18C5 18 2 12 2 12C2 12 5 6 12 6C19 6 22 12 22 12Z"/> <circle cx="12" cy="12" r="3"/> </svg></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="details">
                                        <h4><a href="{{route('product.details' , $prod->id)}}">{{ __($prod->product_name) }}</a></h4>
                                        <p><a href="{{route('product.details' , $prod->id)}}">{{ __($prod->tittle) }} </a></p>
                                        <div class="rating">
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        <span class="woocommerce-Price-currencySymbol">BDT </span>{{ ($prod->after_discount) }}
                                                        &nbsp; &nbsp;
                                                        @if ($prod->discount != '0')

                                                        <span class="woocommerce-Price-currencySymbol"><strike class="text-secondary">  </span>{{ ($prod->price) }} </strike>
                                                        @endif
                                                    </bdi>
                                                </span>
                                            </ins>
                                ...
                                ================================================== -->
                                <div class="modal fade" id="product_id{{ $prod->id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="product_details_content">
                                                                    <h2 class="item_title">{{ $prod->product_name }}</h2>
                                                                    <p>
                                                                        {{ $prod->tittle }}
                                                                    </p>
                                                                    ...
                                                                    <div class="item_price">
                                                                        <span>TK <span id='main_price'>{{ $prod->after_discount }}</span></span>
                                                                        @if($prod->discount !='0')
                                                                    ...
                                                                    <div class="quantity_wrap">
                                                                        ...
                                                                        <div class="total_price">
                                                                            Total: TK <span id="total"> {{ $prod->after_discount }}</span>
                                                                        </div>
                                                                    </div>
                                ...
                                <div class="slider_item">
                                    <div class="category_boxed">
                                        <a href="#!">
                                            ...
                                            <span class="item_title">{{ __($category->catagory_name) }}</span>
                                        </a>
                                    </div>
                                </div>
                                @endforeach
                                    ...
                                    <div class="slider_item">
                                        <div class="small_product_layout">
                                            <a class="item_image" href="shop_details.html">
                                                <img src="{{ asset('assets/images/latest_product/latest_product_1.png')}}" alt="image_not_found">
                                            </a>
                                            <div class="item_content">
                                                <h3 class="item_title">
                    ...
                    <div class="row newarrivals_products">
                        ...
                        <div class="col col-lg-7">
                            <div class="new-arrivals-grids row clearfix">
                                @foreach ($latest_products as $new )

                                <div class="grid col-lg-6">
                                    <div class="product-pic">
                                        <img src="{{asset('uploads/product/product_preview')}}/{{$new->product_image}}" alt>
                                        <div class="actions">
                                            <ul>
                                                <li>
                                                    <a href="#"><svg role="img" xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" viewBox="0 0 24 24" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Favourite</title> <path d="M12,21 L10.55,19.7051771 C5.4,15.1242507 2,12.1029973 2,8.39509537 C2,5.37384196 4.42,3 7.5,3 C9.24,3 10.91,3.79455041 12,5.05013624 C13.09,3.79455041 14.76,3 16.5,3 C19.58,3 22,5.37384196 22,8.39509537 C22,12.1029973 18.6,15.1242507 13.45,19.7149864 L12,21 Z"/> </svg></a>
                                    ...
                                    <div class="details">
                                        ...
                                        <p><a href="{{route('product.details' , $new->id)}}">{{$new->tittle}}</a></p>
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        <span class="woocommerce-Price-currencySymbol">BDT </span>{{$new->after_discount}}
                                                    </bdi>
                                                </span>
                                            </ins>
                                        </span>
                                ...
                                <div class="modal fade" id="product{{$new->id}}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalToggleLabel2">Latest Product Quick View</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="product_details">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="product_details_content">
                                                                    ...
                                                                    <div class="item_price">
                                                                        <span>BDT <span id="main_price">{{$new->after_discount}}</span></span>  </span>
                                                                        @if ($new->discount != 0)
                                                                    ...
                                                                    <div class="quantity_wrap">
                                                                        ...
                                                                        <div class="total">
                                                                            BDT <span id="total">{{$new->after_discount}}</span>
                                                                        </div>
                                                                    </div>
