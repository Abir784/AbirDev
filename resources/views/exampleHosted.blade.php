                ...
                <input type="hidden" value="{{ csrf_token() }}" name="_token" />
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">Sub-Total Amount</h6>
                            </div>
                            <span class="text-muted">{{$data['total']}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">Discounted Amount</h6>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            ...
                            <span class="text-muted">{{$data['delivery_location']}}</span>
                        </li>
                        @php
                        session([
                            'data'=>$data,
                    ...
                    @endphp
                        <li class="list-group-item d-flex justify-content-between">
                            ...
                            <input type="hidden" name="grand_total" value="{{($data['total']-$data['discount'])+$data['delivery_location']}}">
                            <strong>{{($data['total']-$data['discount'])+$data['delivery_location']}} TK</strong>
                        </li>
                    </ul>
